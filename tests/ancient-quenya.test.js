...
describe('Ancient Quenya rules', () => {
  ...
  it('02800 - [d-] > [l-]', () => {
    expect(ancientQuenyaRules['3325625207'].mechanic('abc').out).toBe('abc');
    
    expect(ancientQuenyaRules['3325625207'].mechanic('danme').out).toBe('lanme');
    expect(ancientQuenyaRules['3325625207'].mechanic('dēle').out).toBe('lēle');
    expect(ancientQuenyaRules['3325625207'].mechanic('deluja').out).toBe('leluja');
  ...
  it('03600 - [{ie}ɣV] > [{ie}jV]', () => {
    expect(ancientQuenyaRules['1700576467'].mechanic('abc').out).toBe('abc');

    // eɣV > ejV:
    expect(ancientQuenyaRules['1700576467'].mechanic('teɣē').out).toBe('tejē'); // Only real example
  ...
  it('04000 - [{lr}ɣw] > [{lr}w]', () => {
    expect(ancientQuenyaRules['17019465'].mechanic('abc').out).toBe('abc');
